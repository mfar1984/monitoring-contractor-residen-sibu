...
@section('title', 'Create Company - Monitoring System')
...
<div class="tabs-container">
    ...
    <div class="tabs-content">
        <div style="margin-bottom: 20px;">
            <h2 style="font-size: 14px; font-weight: 600; margin: 0 0 5px 0;">Create Company</h2>
            <p style="font-size: 12px; color: #666; margin: 0;">Add a new contractor company to the system.</p>
        </div>
        ...
        <form method="POST" action="{{ route('pages.master-data.contractor.store') }}">
            @csrf
                ...
                <div style="background-color: white; border: 1px solid #e0e0e0; padding: 15px; margin-bottom: 20px;">
                    ...
                    <div class="form-grid">
                        <div style="grid-column: span 2;">
                            ...
                            <div style="display: flex; gap: 20px;">
                                <label style="display: flex; align-items: center; gap: 5px; font-size: 12px;">
                                    <input type="radio" name="company_category" value="UPKJ" required checked style="width: 18px; height: 18px;">
                                    <span>UPKJ</span>
                                </label>
                                <label style="display: flex; align-items: center; gap: 5px; font-size: 12px;">
                                    <input type="radio" name="company_category" value="Non-UPKJ" style="width: 18px; height: 18px;">
                                    <span>Non-UPKJ</span>
                                </label>
                            </div>
                        </div>
                        <div class="form-field">
                            ...
                            <input type="text" name="company_name" required value="{{ old('company_name') }}" placeholder="Enter company name">
                        </div>
                        <div class="form-field">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" name="code" required value="{{ old('code') }}" placeholder="Enter code">
                        </div>
                        <div class="form-field">
                            <label>Date Established</label>
                            <input type="date" name="date_established" value="{{ old('date_established') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" name="registration_number" required value="{{ old('registration_number') }}" placeholder="e.g., SA20180908">
                        </div>
                        <div class="form-field">
                            <label>Office Registration No. <span class="required">*</span></label>
                            <input type="text" name="office_registration_no" required value="{{ old('office_registration_no') }}" placeholder="e.g., RSBW/RTP - 10222">
                        </div>
                        <div class="form-field">
                            <label>Bumiputera Status</label>
                            <select name="bumiputera_status">
                                @php
                                    $bumistatus = strtolower(old('bumiputera_status', 'ALL'));
                                @endphp
                        ...
                        <div style="grid-column: span 2;">
                            ...
                            <div style="display: flex; gap: 20px;">
                                <label style="display: flex; align-items: center; gap: 5px; font-size: 12px;">
                                    <input type="checkbox" name="registration_status_valid" value="1" style="width: 18px; height: 18px;">
                                    <span>Valid</span>
                                </label>
                                <label style="display: flex; align-items: center; gap: 5px; font-size: 12px;">
                                    <input type="checkbox" name="registration_status_expired" value="1" style="width: 18px; height: 18px;">
                        ...
                        <div style="grid-column: span 2;">
                            <label style="display: flex; align-items: center; gap: 5px; font-size: 12px;">
                                <input type="checkbox" name="rescue_contractor" value="1" style="width: 18px; height: 18px;">
                        ...
                        <div class="form-field">
                            ...
                            <select name="district" id="districtSelect" required>
                                ...
                                @foreach($districts as $district)
                                    <option value="{{ $district->id }}" data-name="{{ $district->name }}" data-division="{{ $district->division_id }}">{{ $district->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-field">
                            <label>Registered Location</label>
                            <input type="text" name="registered_location" value="{{ old('registered_location') }}" placeholder="e.g., SIBU">
                        </div>
                        <div class="form-field" style="grid-column: span 2;">
                            <label>Registered Address <span class="required">*</span></label>
                            <textarea name="registered_address" required rows="2" placeholder="Enter registered address">{{ old('registered_address') }}</textarea>
                        </div>
                        <div class="form-field">
                            <label>Postal Address</label>
                            <textarea name="postal_address" rows="2" placeholder="Enter postal address">{{ old('postal_address') }}</textarea>
                        </div>
                        <div class="form-field">
                            <label>Business Address</label>
                            <textarea name="business_address" rows="2" placeholder="Enter business address">{{ old('business_address') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="form-field">
                            ...
                            <input type="email" name="email" required value="{{ old('email') }}" placeholder="e.g., company@example.com">
                        </div>
                        <div class="form-field">
                            <label>Telephone No. <span class="required">*</span></label>
                            <input type="text" name="telephone_no" required value="{{ old('telephone_no') }}" placeholder="e.g., 0109772727">
                        </div>
                        <div class="form-field">
                            <label>Mobile No.</label>
                            <input type="text" name="mobile_no" value="{{ old('mobile_no') }}" placeholder="e.g., 0109772727">
                        </div>
                        <div class="form-field">
                            <label>Fax No.</label>
                            <input type="text" name="fax_no" value="{{ old('fax_no') }}" placeholder="Enter fax number">
                        </div>
                        <div class="form-field">
                            <label>Contact Person <span class="required">*</span></label>
                            <input type="text" name="contact_person" required value="{{ old('contact_person') }}" placeholder="e.g., Ahmad Ishammudin">
                        </div>
                        <div class="form-field">
                            <label>Contact No.</label>
                            <input type="text" name="contact_no" value="{{ old('contact_no') }}" placeholder="e.g., 0178670308">
                        </div>
                    </div>
                </div>
                ...
                <div style="background-color: white; border: 1px solid #e0e0e0; padding: 15px; margin-bottom: 20px;">
                    <div class="form-grid">
                        <div class="form-field">
                            ...
                            <input type="text" name="authorized_person_name" value="{{ old('authorized_person_name') }}" placeholder="e.g., FAYEZARAH BINTI OTHMAN">
                        </div>
                        <div class="form-field">
                            <label>IC Number</label>
                            <input type="text" name="authorized_person_ic" value="{{ old('authorized_person_ic') }}" placeholder="e.g., 831019-13-6002">
                        </div>
                    </div>
                </div>
                    ...
                    <table class="data-table">
                        <tbody>
                            <tr>
                                ...
                                <td><input type="number" name="manpower_sole_proprietor" min="0" value="0" onchange="calculateTotalManpower()" style="width: 120px;"></td>
                            </tr>
                            <tr>
                                <td style="background-color: #e0e7ff; font-weight: 600;">Management</td>
                                <td><input type="number" name="manpower_management" min="0" value="0" onchange="calculateTotalManpower()" style="width: 120px;"></td>
                            </tr>
                            <tr>
                                <td style="background-color: #e0e7ff; font-weight: 600;">Professional</td>
                                <td><input type="number" name="manpower_professional" min="0" value="0" onchange="calculateTotalManpower()" style="width: 120px;"></td>
                            </tr>
                            <tr>
                                <td style="background-color: #e0e7ff; font-weight: 600;">Sub-Professional</td>
                                <td><input type="number" name="manpower_sub_professional" min="0" value="0" onchange="calculateTotalManpower()" style="width: 120px;"></td>
                            </tr>
                            <tr>
                                <td style="background-color: #e0e7ff; font-weight: 600;">Competent Worker</td>
                                <td><input type="number" name="manpower_competent_worker" min="0" value="0" onchange="calculateTotalManpower()" style="width: 120px;"></td>
                            </tr>
                            <tr style="background-color: #fff3cd;">
                                <td style="font-weight: 700;">Overall Total</td>
                                <td><input type="number" name="manpower_total" readonly value="0" id="manpowerTotal" style="width: 120px; background-color: #f5f5f5; font-weight: 700;"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
/**
 * Add Classification to Mini-Table
 */
function addClassificationToMiniTable(upkjIndex, classification) {
    ...
    row.innerHTML = `
        <td style="padding: 4px 6px;">
            ...
            <input type="hidden" name="upkj[${upkjIndex}][classifications][${rowCount}][class_description]" value="${classification.class_description || ''}">
        </td>
        <td style="padding: 4px 6px;">
            ...
            <input type="hidden" name="upkj[${upkjIndex}][classifications][${rowCount}][head_name]" value="${classification.head_name || ''}">
        </td>
        <td style="padding: 4px 6px;">
            ${subhead || '-'}
...
// Initialize cascading dropdown on page load
