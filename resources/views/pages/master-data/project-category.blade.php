...
@section('title', 'Master Data - Project Category - Monitoring System')
...
@section('content')
    <div class="tabs-container">
        <x-master-data-tabs active="project-category" />
        ...
        <div class="tabs-content">
            ...
            <x-data-table
                ...
                description="Manage project categories for the system."
            ...
            >
                ...
                @empty
                <tr>
                    <td colspan="5" style="text-align: center; padding: 20px;">No project categories found</td>
                </tr>
                @endforelse
            </x-data-table>
        </div>
    ...
    <div class="modal-overlay" id="categoryModal">
        <div class="modal-container">
            ...
            <form id="categoryForm" method="POST" action="{{ route('pages.master-data.project-category.store') }}">
                @csrf
...
function openCreateModal() {
    ...
    document.getElementById('categoryForm').action = '{{ route("pages.master-data.project-category.store") }}';
...
function editCategory(id, name, code, description, status) {
    ...
    document.getElementById('categoryForm').action = '/pages/master-data/project-category/' + id;
...
function deleteCategory(id, name) {
    ...
    document.getElementById('deleteForm').action = '/pages/master-data/project-category/' + id;
