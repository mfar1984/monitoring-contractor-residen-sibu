        ...
        <div class="tabs-content">
            ...
            >
                ...
                <tr>
                    ...
                    <td>{{ number_format($parliament->budget, 2) }}</td>
                    ...
                    <td>
                        <div class="action-buttons">
                            <button class="action-btn action-edit" title="Edit" onclick="editParliament({{ $parliament->id }}, '{{ $parliament->name }}', {{ $parliament->budget }}, '{{ $parliament->code }}', '{{ $parliament->description }}', '{{ $parliament->status }}')">
...
function editParliament(id, name, budget, code, description, status) {
    document.getElementById('modalTitle').textContent = 'Edit Parliament';
    document.getElementById('parliamentForm').action = '/pages/master-data/parliaments/' + id;
    document.getElementById('formMethod').value = 'PUT';
    document.getElementById('parliamentId').value = id;
