...
@section('title', 'Master Data - Residen - Monitoring System')
...
@section('content')
    <div class="tabs-container">
        ...
        <div class="tabs-content">
            ...
            <x-data-table
                title="Residen Categories"
                description="Manage residen categories for user identification."
    ...
    <div class="modal-overlay" id="categoryModal">
        <div class="modal-container">
            ...
            <form id="categoryForm" method="POST" action="{{ route('pages.master-data.residen.store') }}">
                @csrf
...
function openCreateModal() {
    ...
    document.getElementById('categoryForm').action = '{{ route("pages.master-data.residen.store") }}';
...
function editCategory(id, name, code, description, status) {
    ...
    document.getElementById('categoryForm').action = '/pages/master-data/residen/' + id;
...
function deleteCategory(id, name) {
    ...
    document.getElementById('deleteForm').action = '/pages/master-data/residen/' + id;
