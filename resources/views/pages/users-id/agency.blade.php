...
@section('title', 'Agency Users - Monitoring System')
...
@section('content')
    <div class="tabs-container">
        <div class="tabs-header">
            ...
            <a href="{{ route('pages.users-id.agency') }}" class="tab-button active">Agency</a>
        ...
        <div class="tabs-content">
            ...
            <x-data-table
                title="Agency Users"
                description="Content for Agency users will be displayed here."
                createButtonText="Create User"
                createButtonRoute="#"
                searchPlaceholder="Search users..."
                :columns="['Username', 'Full Name', 'Agency', 'Department', 'Status', 'Actions']"
                :data="$users"
                :rowsPerPage="5"
            >
                ...
                <tr>
                    ...
                    <td>{{ $user->agencyCategory->name ?? '-' }}</td>
    ...
    <div class="modal-overlay" id="userModal">
        <div class="modal-container" style="max-width: 600px;">
            ...
            <form id="userForm" method="POST" action="{{ route('pages.users-id.agency.store') }}">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="agency_category_id">Agency <span style="color: #dc3545;">*</span></label>
                        <select id="agency_category_id" name="agency_category_id" required>
                            <option value="">Select Agency List</option>
...
function openCreateModal() {
    ...
    document.getElementById('userForm').action = '{{ route("pages.users-id.agency.store") }}';
...
function editUser(user) {
    ...
    document.getElementById('userForm').action = '/pages/users-id/agency/' + user.id;
    document.getElementById('formMethod').value = 'PUT';
    document.getElementById('userId').value = user.id;
    document.getElementById('agency_category_id').value = user.agency_category_id || '';
...
function deleteUser(id, username) {
    ...
    document.getElementById('deleteForm').action = '/pages/users-id/agency/' + id;
