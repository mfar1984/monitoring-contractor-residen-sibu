...
@section('title', 'Residen Users - Monitoring System')
...
@section('content')
    <div class="tabs-container">
        <div class="tabs-header">
            <a href="{{ route('pages.users-id.residen') }}" class="tab-button active">Residen</a>
        ...
        <div class="tabs-content">
            ...
            <x-data-table
                title="Residen Users"
                description="Content for Residen users will be displayed here."
                createButtonText="Create User"
                createButtonRoute="#"
                searchPlaceholder="Search users..."
                :columns="['Username', 'Full Name', 'Category', 'Department', 'Status', 'Actions']"
                :data="$users"
                :rowsPerPage="5"
            >
                ...
                <tr>
                    ...
                    <td>{{ $user->residenCategory->name ?? '-' }}</td>
    ...
    <div class="modal-overlay" id="userModal">
        <div class="modal-container" style="max-width: 600px;">
            ...
            <form id="userForm" method="POST" action="{{ route('pages.users-id.residen.store') }}">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="residen_category_id">Residen <span style="color: #dc3545;">*</span></label>
                        <select id="residen_category_id" name="residen_category_id" required>
                            <option value="">Select Residen List</option>
...
function openCreateModal() {
    ...
    document.getElementById('userForm').action = '{{ route("pages.users-id.residen.store") }}';
...
function editUser(user) {
    ...
    document.getElementById('userForm').action = '/pages/users-id/residen/' + user.id;
    document.getElementById('formMethod').value = 'PUT';
    document.getElementById('userId').value = user.id;
    document.getElementById('residen_category_id').value = user.residen_category_id || '';
...
function deleteUser(id, username) {
    ...
    document.getElementById('deleteForm').action = '/pages/users-id/residen/' + id;
